...
const governorSurfaceChecks = [
  ...
  [repoPath('docs', 'governor.md'), ['workflow-sync', 'SessionStart', 'Stop', 'handoff.json', 'risks', 'release audit', 'multi_agent', 'child_agents_md', 'durable evidence log', 'not yet admitted as a native governed mode']],
  ...
  [repoPath('README.md'), ['~/.codex/workflows/autoresearch/', 'results.tsv', 'not a native governor-admitted mode']],
  [repoPath('docs', 'install.md'), ['~/.codex/workflows/autoresearch/', 'results.tsv', 'not yet a native governor-admitted mode']],
  ...
  [repoPath('skills', 'autoresearch', 'SKILL.md'), ['$CODEX_HOME/workflows/autoresearch', 'results.tsv', 'fixed layer', 'mutable layer', 'keep-or-revert', 'not yet a native governed mode']],
