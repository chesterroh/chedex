...
const governorSurfaceChecks = [
  ...
  [repoPath('docs', 'install.md'), ['~/.codex/workflows/autoresearch-plan/', '~/.codex/workflows/autoresearch-loop/', 'results.tsv', 'compatibility router']],
  ...
  [repoPath('skills', 'autoresearch', 'SKILL.md'), ['autoresearch-plan', 'autoresearch-loop', 'governed loop', 'compatibility']],
  ...
  [repoPath('skills', 'autopilot', 'SKILL.md'), ['handoff.json', 'architect', 'verifier', 'verification', 'autoresearch-plan', 'autoresearch-loop']],
