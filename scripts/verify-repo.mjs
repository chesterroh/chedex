...
const governorSurfaceChecks = [
  ...
  [repoPath('docs', 'governor.md'), ['workflow-sync', 'SessionStart', 'Stop', 'handoff.json', 'risks', 'release audit', 'multi_agent', 'child_agents_md', 'durable evidence log', 'autoresearch']],
  ...
  [repoPath('README.md'), ['~/.codex/workflows/autoresearch/', 'results.tsv', 'baseline/experiment/ledger loop']],
  [repoPath('docs', 'install.md'), ['~/.codex/workflows/autoresearch/', 'results.tsv', 'autoresearch` / `ralph` / `autopilot`']],
  ...
  [repoPath('skills', 'autoresearch', 'SKILL.md'), ['$CODEX_HOME/workflows/autoresearch', 'results.tsv', 'fixed layer', 'mutable layer', 'keep-or-revert', 'handoff.json', 'progress.json', 'governed workflow owner']],
