...
- If the task is a sequential baseline/experiment/ledger loop rather than independent parallel lanes, prefer `autoresearch-plan`, `autoresearch-loop`, `ralph`, or `autopilot` over `ultrawork`.
