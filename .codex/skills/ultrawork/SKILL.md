...
- Even without `handoff.json`, a completed top-level `ultrawork` still needs `progress.json.verification.review` with a verifier `pass`, matching governor-stamped completion provenance, and a stable evidence reference before stop will clear it.
