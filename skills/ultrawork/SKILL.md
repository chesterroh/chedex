...
- If the task is a sequential baseline/experiment/ledger loop rather than independent parallel lanes, prefer `autoresearch`, `ralph`, or `autopilot` over `ultrawork`.
